<template>
    ...
    <div class="footer-container" id="footer">
        ...
        <div class="footer-items2-container">
            ...
            <div class="store">
                <a href="https://play.google.com/store/apps/details?id=com.tecnavis.babagold" rel="noopener" target="_blank">
                    <img class="pointer" src="https://img.litedev.com/images/static/play-store.svg" alt="youtube-play"/>
                </a> 
                <a href="https://apps.apple.com/us/app/baba-gold/id6736648373" rel="noopener" target="_blank">
